...
ALTER TABLE app_user ADD COLUMN IF NOT EXISTS username VARCHAR(64);
ALTER TABLE app_user ADD COLUMN IF NOT EXISTS password_hash VARCHAR(255);
ALTER TABLE app_user ADD COLUMN IF NOT EXISTS role VARCHAR(32);
ALTER TABLE app_user ADD COLUMN IF NOT EXISTS enabled BOOLEAN;
